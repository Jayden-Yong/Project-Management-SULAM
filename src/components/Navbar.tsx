            ...
            <div className="hidden md:flex items-center gap-4">
              {isSignedIn && user ? (
                <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
                  ...
                  >
                    <img className="h-10 w-10 rounded-full bg-gray-100 object-cover border border-white shadow-sm transition-transform group-hover:scale-105" src={user.imageUrl} alt="Profile" />
              ...
              <>
                <div className="flex items-center gap-3 p-3 mb-3 bg-gray-50 rounded-xl">
                  ...
                  <button
                    ...
                    className="p-2 bg-white rounded-lg border border-gray-200 text-gray-500 hover:text-primary-600"
                  >
